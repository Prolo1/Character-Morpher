    ...
    public partial class CharaMorpher_Core : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            cfg = new MyConfig
            {
                ...
                enableInGame = Config.Bind("_Main_", "Enable In Game", true, new ConfigDescription("Allows the plugin to run (may need to reload if results are not changing)", null, new ConfigurationManagerAttributes { Order = --index })),
                ...
                headIndex = Config.Bind("Adv1 Head", "Head Index", 1, new ConfigDescription("for testing only", new AcceptableValueRange<int>(0, 44), new ConfigurationManagerAttributes { Order = index, IsAdvanced = true })),
